        ...
        <div className="max-w-[1280px] mx-auto px-6 grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 flex flex-col">
              ...
              <div>
                ...
                >
                  <iframe
                    ...
                    src="https://maps.google.com/maps?cid=1076555788113714273&output=embed"
                    width="100%"
                    height="200"
            ...
            <div className="flex gap-3 mt-6 pt-6 border-t border-gray-100">
              <a
                href="https://www.google.com/maps/dir/?api=1&destination_place_id=ChIJZ4zFuIi25YgRYZyYMZHBDwE&destination=8777+San+Jose+Blvd+Suite+302%2C+Jacksonville%2C+FL+32217"
                target="_blank"
                rel="noopener noreferrer"
