...
export const metadata: Metadata = {
  ...
  description:
    "A full-service Jacksonville family-law practice: uncontested divorce, mediation, contested divorce, paternity, child support, time-sharing, and more. Call 904-858-4334.",
